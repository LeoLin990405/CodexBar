...
enum CostUsageScanner {
        ...
        options: Options = Options()) -> CostUsageDailyReport
    {
        ...
        case .openai, .azureopenai, .zai, .gemini, .antigravity, .cursor, .opencode, .opencodego, .alibaba, .factory,
             ...
             .synthetic, .openrouter, .elevenlabs, .warp, .perplexity, .mimo, .doubao, .qwen, .trae, .aigocode,
             .zenmux, .abacus, .mistral, .deepseek, .codebuff, .crof, .windsurf, .venice, .commandcode, .stepfun,
