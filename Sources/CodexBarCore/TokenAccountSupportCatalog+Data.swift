...
extension TokenAccountSupportCatalog {
    static let supportByProvider: [UsageProvider: TokenAccountSupport] = [
        ...
        .antigravity: TokenAccountSupport(
            title: "Google 账户",
            subtitle: "保存多个 Antigravity Google OAuth 账号以便快速切换。",
            placeholder: "Antigravity OAuth 凭证 JSON",
        ...
        .elevenlabs: TokenAccountSupport(
            title: "API 密钥",
            subtitle: "保存多个 ElevenLabs API 密钥。",
            placeholder: "粘贴 API key…",
        ...
        .llmproxy: TokenAccountSupport(
            title: "API 密钥",
            subtitle: "保存多个 LLM 代理 API 密钥。",
            placeholder: "粘贴代理 API key…",
