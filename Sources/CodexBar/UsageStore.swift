    ...
    func debugLog(for provider: UsageProvider) async -> String {
        ...
        let text = await Task.detached(priority: .utility) { () -> String in
            let unimplementedDebugLogMessages: [UsageProvider: String] = [
                ...
                .alibaba: "阿里云百炼 Coding Plan debug log not yet implemented",
                ...
                .kimi: "月之暗面 Kimi debug log not yet implemented",
                .kimik2: "月之暗面 Kimi K2 debug log not yet implemented",
                ...
                .qwen: "Qwen debug log not yet implemented",
                .trae: "Trae debug log not yet implemented",
                .aigocode: "AigoCode debug log not yet implemented",
            ...
            let buildText = {
                ...
                case .gemini, .antigravity, .opencode, .opencodego, .factory, .copilot, .vertexai, .kilo, .kiro, .kimi,
                     .kimik2, .moonshot, .jetbrains, .perplexity, .mimo, .doubao, .qwen, .trae, .aigocode, .zenmux,
