...
- Cost usage: charge forced full rescans of unchanged cached files against the scan budget, and apply the same oversized/budget limits to inherited parent baseline reads used by forks/subagents.
